          ...
          <nav className="flex justify-between bg-gradient-to-b from-[#85A693] to-[#f2f2f2] text-[#1C3240] w-screen">
            <div className="px-5 xl:px-12 py-6 flex w-full items-center">
              ...
              <ul className="hidden md:flex px-4 mx-auto font-semibold text-lg space-x-12">
                <li><Link to="/home" className=" hover:text-black  hover:underline">Home</Link></li>
                <li><Link to="/about" className="hover:text-black  hover:underline">Sobre</Link></li>
                <li><Link to="/produtos" className="hover:text-black  hover:underline">Produtos</Link></li>
                <li><Link to="/categorias" className="hover:text-black hover:underline">Categorias</Link></li>
              </ul>
              {/* <!-- Header Icons --> */}
