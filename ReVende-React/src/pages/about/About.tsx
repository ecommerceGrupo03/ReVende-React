    ...
    <>
      <div className="relative flex flex-col py-16 lg:pt-0 lg:flex-col lg:pb-0">
        ...
        <div className="inset-y-0 right-0 w-full max-w-xl px-4 mx-auto lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
          <img
            className="object-cover w-full h-48 rounded shadow-lg lg:rounded-none lg:shadow-none sm:h-96 lg:h-full"
            src={encomendaFoto}
            alt=""
          />
        </div>
        ...
        <div className="flex flex-col items-end w-full max-w-xl px-4 mx-auto lg:px-8 lg:max-w-screen-xl">
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            <div className="max-w-xl mb-6">
              ...
              <p className="text-base text-gray-700 md:text-lg">
                Aborda a temática da produção e consumo sustentáveis, concentrando-se em iniciativas tanto globais quanto locais. 
                Isso envolve a promoção do uso eficiente dos recursos naturais, a minimização do desperdício de alimentos e a gestão responsável de resíduos químicos. 
                Este objetivo também engloba o cuidado com os resíduos sólidos e a redução da emissão de poluentes. 
