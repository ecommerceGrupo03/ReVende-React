                        ...
                        <div className="relative flex flex-col min-w-0 h-full break-words bg-white w-full shadow-xl rounded-lg -mt-64 ">
                            <div className="px-6">
                                <div className="flex flex-wrap justify-center">
                                    ...
                                    <div className="w-full lg:w-4/12 lg:order-3 lg:text-right lg:self-center flex sm:justify-end justify-center">
                                        <div className="py-0 lg:py-6 px-16 mt-24 sm:mt-0">
                                            <button
